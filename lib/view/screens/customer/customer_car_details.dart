  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("Customer Car Details",style: TextStyle(fontSize: 22,fontWeight: FontWeight.bold,color: Colors.white),)
      ),
            ...
            children: [
                ...
                child: Container(
                  ...
                  child: Row(
                    children: [
                      ...
                      SizedBox(width: 10,),
                      Expanded(child: Text("Following are the best Flutter packages which can generate lorem ispum text Lorem Ipsum is simply dummy text used in many programming language.",style: TextStyle(fontSize: 15,fontWeight: FontWeight.normal),))
                    ],
                  ),
                ),
              ),
              ...
              Center(
                child: CustomButton(
                  buttonText: "Save",
                  onTap: (){
                    Navigator.push(context, MaterialPageRoute(builder: (builder)=>AddVehicleInfo()));
                  },
                ),
              )
            ],
