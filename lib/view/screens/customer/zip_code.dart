    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: Column(
          ...
          children: [
            Text("Please provide a Zip Code or address, So we can get you estimates from shops near by.",style: TextStyle(fontSize: 15,fontWeight: FontWeight.normal),),
            SizedBox(height: 20,),
            SearchWidget(controller: zipCodeController, hintText: "Search Services,Store", onClearPressed: (){}, onSubmit: (){}),
            SizedBox(height: 20,),
            Container(
