...
import 'package:carcheck/view/screens/customer/vehicle/view_vehicles.dart';
import 'package:carcheck/view/screens/customer/view_address.dart';
...
class _ProfilePageState extends State<ProfilePage> {
  ...
  void initState() {
    ...
    fnameController.text = authProvider.userDetails!.firstName.toString();
    lnameController.text = authProvider.userDetails!.lastName.toString();
    mobileController.text = authProvider.userDetails!.mobilenumber.toString();
    emailController.text = authProvider.userDetails!.emailid.toString();
    super.initState();
  }
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  ...
                  model.userDetails!.garrageOwner == 'true'?InkWell(
                    child: const Text(
                      "Garage Details",
                      style: TextStyle(
                        fontSize: 17,
                    ...
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => ViewVehicles()),
                      );
                    },
                  ):InkWell(
                    child: Text(
