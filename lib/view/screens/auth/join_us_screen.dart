...
import 'package:carcheck/view/screens/auth/registration_page.dart';
import 'package:carcheck/view/screens/customer/customer_car_details.dart';
              ...
              child: Container(
                ...
                child: Row(
                  ...
                  //  SvgPicture.asset("assets/svg/customer.svg",height: 50,width: 50,color: isSelectedCustomer?ColorResources.PRIMARY_COLOR:Colors.black,),
                    ...
                    Text("A Customers",style:TextStyle(color: isSelectedCustomer?ColorResources.PRIMARY_COLOR:Colors.black)),
