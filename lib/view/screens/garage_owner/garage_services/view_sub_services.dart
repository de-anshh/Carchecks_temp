...
class _ViewServicesState extends State<ViewServices> {
  ...
  @override
  void initState() {
    garageProvider.getAllGarageServices();
  }
            ...
            Expanded(
              child: Container(
                  ...
                  child: ListView.builder(
                      itemCount: model.allGarageServiceList.length,
                      shrinkWrap: true,
                                              ...
                                              showDialog(
                                                  ...
                                                  builder: (_) =>
                                                      CupertinoAlertDialog(
                                                        title: const Text(
                                                          'Are you sure want to deleted your post?',
                                                          // style: Style.heading,
                                                        ),
                                                        actions: <Widget>[
                                                          TextButton(
                                                            ...
                                                            onPressed: () {
                                                              model.deleteGarageService(model.allGarageServiceList[index])
                                                                  .then((value) => {
                                                                showAnimatedDialog(
                                                                    context,
                                                                    MyDialog(
